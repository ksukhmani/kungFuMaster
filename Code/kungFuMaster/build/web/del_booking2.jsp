...
<%
  ...
  <div class="container">
            ...
            <% String sp_email = session.getAttribute("sp_email").toString();
                ...
                ResultSet rs1 = stmt1.executeQuery("select * from booking where sp_email=\'" + sp_email + "\' and date=\'" +date1+ "\'");
                if (rs1.next()) {
                    rs1.previous();
            %>
            ...
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <input type="button" class="btn-success" value="Delete" onclick="cancel('<%=bid%>','<%=date1%>')" style="background: rgb(25,52,81);color:white"/>
                    </td>
