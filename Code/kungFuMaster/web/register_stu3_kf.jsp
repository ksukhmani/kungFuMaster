...
<html>
    <head>
        ...
        <script>
           ...
           function goo()
           {
               alert("Student Registered with student id: 1");
           }
            ...
            <form class="form-horizontal"  method="post"  >
               ...
               <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-10"><input type="text" class="form-control" name="pcontact"  id="pcontact" style="margin-bottom:15px" disabled/></div></div>
                    
                    <div class="form-group">
                    <label class="col-sm-2">Mother's Name</label>
                    <div class="col-sm-10"><input type="text" class="form-control" name="mname"  id="mname" style="margin-bottom:15px" disabled/></div></div>
                    
                    <div class="form-group">
                    <label class="col-sm-2">Email</label>
                    <div class="col-sm-10"><input type="text" class="form-control" name="memail"  id="memail" style="margin-bottom:15px" disabled/></div></div>
                    
                    <div class="form-group">
                    <label class="col-sm-2">Contact No.</label>
                    <div class="col-sm-10"><input type="text" class="form-control" name="mcontact"  id="mconatct" style="margin-bottom:15px" disabled/></div></div>
                    
                    
                    <div class="form-group">
                    <label class="col-sm-2">Father's Name</label>
                    <div class="col-sm-10"><input type="text" class="form-control" name="faname"  id="faname" style="margin-bottom:15px" disabled/></div></div>
                    
                    <div class="form-group">
                    <label class="col-sm-2">Email</label>
                    <div class="col-sm-10"><input type="text" class="form-control" name="femail"  id="femail" style="margin-bottom:15px" disabled/></div></div>
                    
                    <div class="form-group">
                    <label class="col-sm-2">Contact No.</label>
                    <div class="col-sm-10"><input type="text" class="form-control" name="fcontact"  id="fcontact" style="margin-bottom:15px" disabled/></div></div>
